...
public final class ComponentFactory {
    ...
    public static MoveComponent moveComponent(boolean targetRelate, float destinationX, float destinationY, boolean force) {
        MoveComponent c = new MoveComponent();
        c.set(targetRelate,destinationX, destinationY, force);
        return c;
    }
